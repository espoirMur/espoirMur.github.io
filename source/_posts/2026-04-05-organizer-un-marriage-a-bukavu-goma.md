...
{% include image.html name="introduction.jpg" caption="The Introduction Ceremony" %}
...
{% include image.html name="dot.png" caption=" The dowry Ceremony, What they brought for the Ceremony" %}
...
{% include image.html name="venue-decoration.jpg" caption="The Venue where the first wedding happened" %}
...
{% include image.html name="venue-patricia.png" caption="The Venue where the Second Ceremony Happened" %}
...
<summary><strong>Conclusion & Disclaimer</strong></summary>
